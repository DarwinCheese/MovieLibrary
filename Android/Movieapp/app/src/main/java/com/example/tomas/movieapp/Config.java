...
public class Config {
    ...
    public static final String URL_FILMS ="https://node-movielibrary.herokuapp.com/api/v1/films";
    public static final String URL_RENTALS ="https://node-movielibrary.herokuapp.com/api/v1/rentals";
}
